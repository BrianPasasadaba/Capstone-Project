...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupSearch(inputId, hiddenInputId, optionsListId) {
    ...
    setupSearch('cralarm-dec-search', 'cralarm-dec', 'cralarm-dec-options');
    setupSearch('crfunder-dec-search', 'crfunder-dec', 'crfunder-dec-options');
    setupSearch('crfout-dec-search', 'crfout-dec', 'crfout-dec-options');
    setupSearch('crground-search', 'crground', 'crground-options');
    setupSearch('crsafety-search', 'crsafety', 'crsafety-options');
    setupSearch('crsender-search', 'crsender', 'crsender-options');
});